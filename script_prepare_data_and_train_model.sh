...
echo "3. runs: openai api fine_tunes.create -t data/parsed_twitter_data_"$twitter_handle"_prepared.jsonl -m "$openai_engine""
openai api fine_tunes.create -t data/parsed_twitter_data_"$twitter_handle"_prepared.jsonl -m $openai_engine
